...
export const appendRecipeToUser = (
  ...
  axios
    .post(
      REACT_APP_BACKEND_URL + USERS_PATH + RECIPES_PATH,
      recipeData,
      headers
    )
    .then(callback)
...
export const checkIfIngredientsAreInStock = (
  ...
  axios
    .post(
      REACT_APP_BACKEND_URL + USERS_PATH + INVENTORIES_PATH + CHECK_PATH,
      ingredientsArray,
      headers
    )
    .then(callback)
...
export const appendGroceryItemToUser = (
  ...
  axios
    .post(
      REACT_APP_BACKEND_URL + USERS_PATH + GROCERIES_PATH,
      itemData,
      headers
    )
    .then(callback)
...
export const appendInventoryItemToUser = (
  ...
  axios
    .post(
      REACT_APP_BACKEND_URL + USERS_PATH + INVENTORIES_PATH,
      itemData,
      headers
    )
    .then(callback)
